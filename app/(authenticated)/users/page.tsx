...
export default function UsersPage() {
    ...
    const columns: ColumnDef<TClerkUser>[] = [
        ...
        },
        {
            ...
            cell: ({ row }) => {
                ...
                return isBanned ? <Badge variant="destructive">Banned</Badge> : isEligible ? <Badge>Allowed</Badge> : <Badge variant="destructive">Need Approval</Badge>;
            }
        },
        {
            id: "action",
    ...
    return <Page
        isLoading={isLoading}
        title="Pengguna"
        headerAction={<Link href="/users/create"><Button>
            <Plus className="mr-2" />
            Tambah Pengguna</Button></Link>}
