...
--> statement-breakpoint
ALTER TABLE "customers" RENAME COLUMN "institution" TO "institution";--> statement-breakpoint
ALTER TABLE "customers" ALTER COLUMN "name" SET DATA TYPE varchar(255);--> statement-breakpoint
...
ALTER TABLE "book_titles" ADD CONSTRAINT "book_titles_subject_id_subjects_id_fk" FOREIGN KEY ("subject_id") REFERENCES "public"."subjects"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
